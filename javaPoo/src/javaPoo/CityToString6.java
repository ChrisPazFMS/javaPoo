...
public class CityToString6 {
	...
	public CityToString6(String city, String country, int people) {
	...
	public CityToString6(String city, int people) {
		setCity(city);
	...
	public void display() {
		if(getCity() == "Toulouse") {
			...
			System.out.println("ville de " + getCity() + " en "+ getCountry() + " ayant " + this.getPeople() + " habitans");
